...
namespace Trabajodememo
{
    public partial class Form1 : Form
    {
        ...
        db D = new db();
                ...
                string[] whatever2 = new string[100];
        ...
        public void Form1_Load(object sender, EventArgs e)
        {
          //  this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.Fixed3D;
            this.MinimumSize = new Size(673, 674);
            this.MaximumSize = new Size(1603,674);
            ...
            else
            {
                try
                {
                    ...
                    for (int y = objarray.Count; y < objarray.Count + 1; y++)
                    {
                        ...
                        objarray[y - 1].datecreated = DateTime.Today.ToString("MM.dd.yyyy");
        ...
        {
            richTextBox1.SelectionTabs = new int[]  {42,130,202,243,295,363,513,575,639,735,850,925,1000,1090,1185,1302,1374,1430,1500};
        }
        string[] whatever = new string[1000000];
     ...
     // Printing Part
            ...
            try
            {
                ...
                while (x<500)
                {
                    ...
                    D.xlWorkSheet2.Cells[x, 1] = "";
                            ...
                            D.xlWorkSheet2.get_Range("A" + x, "C" + x).Borders[Excel.XlBordersIndex.xlEdgeRight].LineStyle = Excel.XlLineStyle.xlLineStyleNone;
                ...
                {   
                    for (int h = 0; h < (totaldrugs); h++)
                    {
                        if (D.xlWorkSheet.Cells[y, 18].Value.ToString() == arr[h])
                        {
                            ...
                            D.xlWorkSheet2.Cells[x, 4] = "Drugs";
                            D.xlWorkSheet2.Cells[x, 5] = "No";
                ...
                for (int y = 2; y <= D.count; y++)
                {
                    for (int h = 0; h < (totalalcohol); h++)
                    {
                        if (D.xlWorkSheet.Cells[y, 18].Value.ToString() == temp[h])
                        {
                            ...
                            D.xlWorkSheet2.Cells[x, 2] = D.xlWorkSheet.Cells[y, 15];
                            D.xlWorkSheet2.Cells[x, 3] = D.xlWorkSheet.Cells[y, 1];
                            D.xlWorkSheet2.Cells[x, 4] = "Alcohol";
                            D.xlWorkSheet2.Cells[x, 5] = "No";
                            D.xlWorkSheet2.Cells[x, 7] = DateTime.Today.ToString("MM.dd.yyyy");
                            x++;
                        }
        ...
        private void button13_Click(object sender, EventArgs e)//Actualizar Random boton
        {
            try
            {
                ...
                {//richTextBox3.Text += "doing";
                    ...
                    { 
                        MessageBox.Show("There are not enought participants");
                        break;
                ...
                {//richTextBox3.Text += "doing";
                    string number2 = Convert.ToString(drugalco.Next(0, arr2.Count));
                      //  arr.Add((arr2[Convert.ToInt16(number2)]));
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int countdot = 0; int countnon = 0; int countpre = 0;
                ...
                for (int g = 2; g <= D.count; g++)
                {
                    ...
                    else if (string.Equals(D.xlWorkSheet.Cells[g, 17].Value.ToString(), "DOT", StringComparison.CurrentCultureIgnoreCase))
                    {
                        countdot++;
                    }
                    else if (string.Equals(D.xlWorkSheet.Cells[g, 17].Value.ToString(), "NON", StringComparison.CurrentCultureIgnoreCase))
                    {
                        countnon++;
                    }
                ...
                this.chart1.Series["Total"].Points.AddXY("DOT", countdot);
                this.chart1.Series["Total"].Points.AddXY("NON", countnon);
                ...
                this.chart2.Series["Total"].Points.AddXY("DOT", countdot);
                this.chart2.Series["Total"].Points.AddXY("NON", countnon);
        ...
        {
            richTextBox4.SelectionTabs = new int[] { 52, 123, 202, 258, 325, 410, 530, 590, 650, 750, 838, 900, 970, 1045, 1119, 1220 };
        }
